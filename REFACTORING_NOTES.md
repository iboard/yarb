...
While writing the documentation of the service I wrote, "maybe the
content for the pages will come from different source in future
versions". So, the name MD... is misleading and should be more general.
